...
export function HeroSection({ t }) {
  ...
  const translations = t || { 
    ...
    subtitleEnd: '',
    description: 'Supports version control, team collaboration, smart categorization, and more. Streamline your workflow and unlock the full potential of your AI prompts.',
      ...
      <div className="relative container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-700 mb-4">
            ...
            <TypeAnimation
              sequence={translations.animatedText.flatMap(item => [item, 2500])} // Slightly faster animation
              wrapper="span"
